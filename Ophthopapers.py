...
Time-based Filtering Enhancements in v1.1.1:
...
8. Improved today's articles fetching with comprehensive date field coverage
...
def fetch_recent_ophthalmology_articles(email, api_key=None, days_back=30, max_results=1000, min_impact_factor=0.0, subspecialty=None, today_only=False, month_only=False, search_keyword=None, specific_journal=None, specific_year=None, date_range_type=None, custom_start_date=None, custom_end_date=None, seasonal_filter=None):
    ...
    if date_range_type:
        ...
        # Build a more comprehensive query to target today's publications
        ...
        date_query = (
            ...
            f'"{today.strftime("%Y/%m/%d")}"[Date - Medline] OR '
            f'"{today.strftime("%Y/%m/%d")}"[Date - Entrez] OR '
            f'"{today.strftime("%Y/%m/%d")}"[EDAT] OR '
            f'"{today.strftime("%Y/%m/%d")}"[PDAT] OR '
            f'"{today.strftime("%Y/%m/%d")}"[MHDA] OR '
            f'"{today.strftime("%Y")}/{today.strftime("%m")}/{today.strftime("%d")}"[Date - Publication])'
        )
